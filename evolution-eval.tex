...
\begin{table}[h]
  \begin{tabular}{lccc} 
      \textbf{CPU} & \textbf{\texttt{syscall}} & \textbf{\texttt{sysret}}  & \textbf{swap \texttt{cr3}} \\ \hline 
      Broadwell             & 49 & 40 & 206 \\
...
\begin{table}[h]
\begin{tabular}{ rcccc }
  \textbf{CPU} & \textbf{Baseline} & \textbf{IBRS} & \textbf{Generic} & \textbf{AMD} \\ \hline
  Broadwell           & 16 & +32 & +28 & \tiny{N/A} \\
  Skylake Client      & 11 & +15 & +19 & \tiny{N/A} \\
  Cascade Lake        & 3 & +0 & +49 & \tiny{N/A} \\
  Ice Lake Client     & 5 & +0 & +21 & \tiny{N/A} \\
  Ice Lake Server     & 1 & +1 & +50 & \tiny{N/A} \\
  Zen 2               & 3 & +13 & +14 & +0 \\
