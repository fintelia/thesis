...
LEBench~\cite{ren:lebench} is a collection of microbenchmarks for measuring specific operating system operations.\footnote{We use the version of the LEBench benchmarks distributed with the \textsc{ward} system~\cite{behrens:ward}, which addresses a few issues with the original.}
